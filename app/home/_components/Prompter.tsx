...
export default function Prompter () {
    ...
    return <div className="max-w-2/5 mx-auto my-10">
        ...
        <div className="wrapper">
            ...
            <textarea placeholder="Write your story idea or concept here...." rows={ 2 } className="w-full p-4 outline-0" />
            ...
            <div className={`${ baseStyle.inlineRow } p-4`}>
                ...
                <Button type="Primary" icon={ MdOutlineAutoAwesome} label="Generate Big Idea" />
            </div>
        </div>
    </div>
}